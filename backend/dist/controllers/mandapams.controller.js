...
exports.getApprovedMandapams = getApprovedMandapams;
exports.getFeaturedMandapams = getFeaturedMandapams;
exports.getMandapamById = getMandapamById;
exports.createMandapamSubmission = createMandapamSubmission;
 ...
 */
async function getApprovedMandapams(req, res) {
    try {
 ...
 */
async function getMandapamById(req, res) {
    try {
 ...
 */
async function createMandapamSubmission(req, res) {
    try {
        ...
        handleServiceError(res, error, 'Internal server error while saving submission');
    }
}
